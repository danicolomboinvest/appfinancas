...
export const game: Voz = {
  ...
  titulos: {
    ...
    casRendaBHint: "Líquida também.",
    casDespesas: "Despesas comuns do mês",
    casDespesasHint: "Aluguel, mercado, contas da casa: o custo do time, não o gasto individual de cada jogador.",
    casDespesasSugestao: (valor) => `O time gastou ${valor} este mês`,
    ...
    casPctDica: "Em branco, o app calcula pela renda de cada um.",
    ...
    invReceitaHintVenda: "O que você espera vender a mais por causa dele. Usa a média, não o melhor mês da temporada.",
    ...
    invMargemHint: "A margem de contribuição da empresa, pela DRE. Vender mais só vale o que sobra depois de mercadoria, taxa e frete.",
    ...
    invVeredictoNuncaSePagaTexto: "O custo novo por mês consome toda a margem que a receita nova traz. Esse investimento nunca fecha o combo.",
    ...
    invGraficoDescSupera: (mes) => `A empresa ultrapassa a aplicação no mês ${mes}. Virada de jogo.`,
    invGraficoDescNaoSupera: "No prazo dado, a aplicação vence esse round.",
    invGraficoLegendaEmpresa: "Na empresa",
    invGraficoLegendaAplicacao: "Na aplicação",
    invReceitaNecessariaAntes: (horizonte) => `Pra vencer em ${horizonte} meses, esse investimento precisa trazer pelo menos `,
